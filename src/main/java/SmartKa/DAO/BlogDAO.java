...
//	public static ArrayList<Blog> getBlogP1() {
//
//		ArrayList<Blog> blogList = new ArrayList<Blog>();
//		try {
//			String query = Constant.SELECT_BLOG_PAGE1;
//			PreparedStatement ps = BlogDAO.connection.prepareStatement(query);
//			ResultSet rs = ps.executeQuery();
//			while(rs.next()) {
//				Blog sblog = new Blog(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12), rs.getString(13));
//				blogList.add(sblog);
//			
//			}
//		} catch (Exception e) {
...
//		return blogList;
//	}
//	public static ArrayList<Blog> getBlogP2() {
//
//		ArrayList<Blog> blogList = new ArrayList<Blog>();
//		try {
//			String query = Constant.SELECT_BLOG_PAGE2;
//			PreparedStatement ps = BlogDAO.connection.prepareStatement(query);
//			ResultSet rs = ps.executeQuery();
//			while(rs.next()) {
//				Blog sblog = new Blog(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12), rs.getString(13));
