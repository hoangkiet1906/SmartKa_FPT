...
public class ProductDAO {
	...
	public static ArrayList<Product> getAllProduct() {
		...
		try {
			...
			ResultSet rs = ps.executeQuery();
			while (rs.next()) {
				Product bean = new Product(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getInt(4), rs.getString(5),
		...
		try {
			...
			for (String stringTag : listTagArrayList) {
				try {
					...
					while (rs2.next()) {
						Product bean2 = new Product(rs2.getInt(1), rs2.getString(2), rs2.getInt(3), rs2.getInt(4),
								rs2.getString(5), rs2.getString(6), rs2.getString(7), rs2.getInt(8), rs2.getString(9),
	...
	public static void main(String[] args) {
		...
		System.out.println(ProductDAO.CalculatingRevenue());
