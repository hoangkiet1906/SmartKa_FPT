...
<body>
	<div class="main-wrapper main-wrapper-2">
									...
									<ul>
										...
										<li><a href="shop.html">SHOP</a>
											<ul class="mega-menu-style mega-menu-mrg-1">
												<li>
													<ul>
														<li><a class="dropdown-title" href="#">Shop
																Layout</a>
															<ul>
														...
														<li><a class="dropdown-title" href="#">Products
																Layout</a>
															<ul>
														...
														<li><a href="shop.html"><img
																src="assets/images/banner/menu.png" alt=""></a></li>
													</ul>
												</li>
											</ul></li>
										<li><a href="#">PAGES</a>
						...
						<div class="row">
							<div class="col-lg-3 col-md-6 col-sm-6 col-12">
								<div class="footer-widget footer-about mb-40">
									...
									<p>Lorem ipsum dolor sit amet, cons adipi elit, sed do
										eiusmod tempor incididunt ut aliqua.</p>
			...
			<div class="bg-gray-3">
				<div class="container">
					<div class="footer-bottom copyright text-center bg-gray-3">
						<p>
							Copyright ©2021 All rights reserved | Made with <i
								class="fa fa-heart"></i> by <a href="https://hasthemes.com/">
								HasThemes</a>.
						</p>
					</div>
				</div>
		...
		<!-- Product Modal start -->
		<div class="modal fade quickview-modal-style" id="exampleModal"
							...
							<div class="col-lg-7 col-md-7 col-12">
								<div class="product-details-content quickview-content">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
										Integer ornare tincidunt neque vel semper. Cras placerat enim
										sed nisl mattis eleifend.</p>
