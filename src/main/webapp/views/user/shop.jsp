									...
									<div class="product-wrap mb-35" data-aos="fade-up"
										...
										<div class="product-content">
											...
											<div class="product-price">
												<span class="old-price">$25.89 </span> <span
													class="new-price">$20.25 </span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-lg-4 col-md-4 col-sm-6 col-12">
									<div class="product-wrap mb-35" data-aos="fade-up"
										...
										<div class="product-content">
											...
											<div class="product-price">
												<span class="old-price">$45.00 </span> <span
								...
								<div class="row">
									...
									<div class="col-lg-8 col-sm-7">
										<div class="shop-list-content">
											...
											<div class="product-price">
												<span class="old-price">$70.89 </span> <span
													class="new-price">$55.25 </span>
											</div>
								...
								<div class="row">
									...
									<div class="col-lg-8 col-sm-7">
										<div class="shop-list-content">
											...
											<div class="product-price">
												<span class="old-price">$80.89 </span> <span
													class="new-price">$60.25 </span>
											</div>
											<div class="product-list-rating">
												<i class=" ti-star"></i> <i class=" ti-star"></i> <i
													class=" ti-star"></i> <i class=" ti-star"></i> <i
								...
								<div class="row">
									...
									<div class="col-lg-8 col-sm-7">
										<div class="shop-list-content">
											...
											<div class="product-price">
												<span class="old-price">$45.89 </span> <span
													class="new-price">$30.25 </span>
											</div>
											<div class="product-list-rating">
												<i class=" ti-star"></i> <i class=" ti-star"></i> <i
													class=" ti-star"></i> <i class=" ti-star"></i> <i
				...
				<div class="sidebar-wrapper">
					...
					<div class="sidebar-widget" data-aos="fade-up" data-aos-delay="200">
						...
						<div class="sidebar-widget-tag">
							<a href="#">All, </a> <a href="#">Clothing, </a> <a href="#">
								Kids, </a> <a href="#">Accessories, </a> <a href="#">Stationery,
							</a> <a href="#">Homelife, </a> <a href="#">Appliances, </a> <a
								href="#">Clothing, </a> <a href="#">Baby, </a> <a href="#">Beauty
							</a>
						</div>
					</div>
				</div>
